...
_Сценарий 2.1.1 Тестирование поля "Номер карты" для вкладки "Купить". Позитивное_
...
4. Ожидаемый результат - кнопка "Продолжить" нажимается, форма отправляется, на экране появляется сообщение о статусе ответа.

_Сценарий 2.1.2 Тестирование поля "Номер карты" для вкладки "Купить". Негативное_
1. Выполнить сценарии 1.1 или 1.3;
2. Внести в поле значения:
   - 444444444444444
   - 444444444444444Ч
...
_Сценарий 2.1.3 Тестирование поля "Номер карты" для вкладки "Купить". Негативное_
1. Выполнить сценарии 1.1 или 1.3;
2. Внести в поле значения:
   - 44444444444444412
3. Остальные поля формы заполнить валидными значениями, кликнуть по кнопке "Продолжить";
...
_Сценарий 2.1.4 Тестирование поля "Номер карты" для вкладки "Купить". Негативное_
1. Выполнить сценарии 1.1 или 1.3;
2. Внести в поле значения:
   - два пробела;    
   - *
...
_Сценарий 2.2.1 Тестирование поля "Месяц" для вкладки "Купить". Позитивное_
1. Выполнить сценарии 1.1 или 1.3;
2. Внести в поле значения:
   - 12
   - 11
...
_Сценарий 2.2.2 Тестирование поля "Месяц" для вкладки "Купить". Позитивное_
1. Выполнить сценарии 1.1 или 1.3;
2. Внести в поле значения:
   - -1
3. Остальные поля формы заполнить валидными значениями, кликнуть по кнопке "Продолжить";
...
_Сценарий 2.2.3 Тестирование поля "Месяц" для вкладки "Купить". Негативное_
1. Выполнить сценарии 1.1 или 1.3;
2. Внести в поле значения:
   - 0
3. Остальные поля формы заполнить валидными значениями, кликнуть по кнопке "Продолжить";
...
_Сценарий 2.2.4 Тестирование поля "Месяц" для вкладки "Купить". Негативное_
1. Выполнить сценарии 1.1 или 1.3;
2. Внести в поле значения:
   - 13
3. Остальные поля формы заполнить валидными значениями, кликнуть по кнопке "Продолжить";
...
_Сценарий 2.2.5 Тестирование поля "Месяц" для вкладки "Купить". Негативное_
1. Выполнить сценарии 1.1 или 1.3;
2. Внести в поле значения:
   - ии
   - hj
...
_Сценарий 2.3.1 Тестирование поля "Год" для вкладки "Купить". Позитивное_
...
_Сценарий 2.3.2 Тестирование поля "Год" для вкладки "Купить". Негативное_
...
_Сценарий 2.3.3 Тестирование поля "Год" для вкладки "Купить". Негативное_
...
_Сценарий 2.3.4 Тестирование поля "Год" для вкладки "Купить". Негативное_
...
_Сценарий 2.4.1 Тестирование поля "CVC/CVV" для вкладки "Купить". Позитивное_
1. Выполнить сценарии 1.1 или 1.3;
2. Внести в поле значения:
   - 123
   - 000
...
_Сценарий 2.4.2 Тестирование поля "CVC/CVV" для вкладки "Купить". Негативное_
1. Выполнить сценарии 1.1 или 1.3;
2. Внести в поле значения:
   - 1
3. Остальные поля формы заполнить валидными значениями, кликнуть по кнопке "Продолжить";
...
_Сценарий 2.4.3 Тестирование поля "CVC/CVV" для вкладки "Купить". Негативное_
1. Выполнить сценарии 1.1 или 1.3;
2. Внести в поле значения:
   - два пробела
   - sdd
...
_Сценарий 2.5.1 Тестирование поля "Владелец" для вкладки "Купить". Позитивное_
1. Выполнить сценарии 1.1 или 1.3;
2. Внести в поле значения:
...
_Сценарий 2.5.2 Тестирование поля "Владелец" для вкладки "Купить". Позитивное_
1. Выполнить сценарии 1.1 или 1.3;
2. Внести в поле значения:
   - <Вася Кац>
   - "Вася"
   - Ян_Кузнецов
3. Остальные поля формы заполнить валидными значениями, кликнуть по кнопке "Продолжить";
4. Ожидаемый результат - в поле внесено значение без символов, кнопка "Продолжить" нажимается, форма отправляется, на экране появляется сообщение о статусе ответа.

_Сценарий 2.5.3 Тестирование поля "Владелец" для вкладки "Купить". Негативное_
1. Выполнить сценарии 1.1 или 1.3;
2. Внести в поле значения:
...
_Сценарий 2.5.4 Тестирование поля "Владелец" для вкладки "Купить". Негативное_
1. Выполнить сценарии 1.1 или 1.3;
2. Внести в поле значения:
   - два пробела
3. Остальные поля формы заполнить валидными значениями, кликнуть по кнопке "Продолжить";
...
_Сценарий 2.6.1  Тестирование полей "Месяц", "Год" для вкладки "Купить". Позитивное_
...
5. Ожидаемый результат - кнопка "Продолжить" нажимается, форма отправляется, на экране появляется сообщение о статусе ответа.

_Сценарий 2.6.2  Тестирование полей "Месяц", "Год" для вкладки "Купить". Позитивное_
...
_Сценарий 2.6.3  Тестирование полей "Месяц", "Год" для вкладки "Купить". Негативное_
...
_Сценарий 2.6.4  Тестирование полей "Месяц", "Год" для вкладки "Купить". Негативное_
...
_Сценарий 2.7  Тестирование отправки формы "Купить"_
...
_Сценарий 2.7.1  Тестирование отправки формы "Купить". Позитивное_
1. Выполнить сценарии 1.1 или 1.3;
...
8. Ожидаемый результат - кнопка "Продолжить" нажимается, форма отправляется, на экране появляется сообщение о статусе ответа.

_Сценарий 2.7.2  Тестирование отправки формы "Купить". Негативное_
1. Выполнить сценарии 1.1 или 1.3;
2. Внести в поле "Номер карты" значение: валидное;
...
_Сценарий 2.7.3  Тестирование отправки формы "Купить". Негативное_
1. Выполнить сценарии 1.1 или 1.3;
2. Внести в поле "Номер карты" значение: валидное;
...
_Сценарий 2.7.4  Тестирование отправки формы "Купить". Негативное_
1. Выполнить сценарии 1.1 или 1.3;
...
_Сценарий 2.7.5  Тестирование отправки формы "Купить". Негативное_
1. Выполнить сценарии 1.1 или 1.3;
2. Внести в поле "Номер карты" значение: не валидное;
3. Внести в поле "Месяц" значение: не валидное;
4. Внести в поле "Год" значение: валидное;
...
_Сценарий 2.7.6  Тестирование отправки формы "Купить". Негативное_
1. Выполнить сценарии 1.1 или 1.3;
2. Внести в поле "Номер карты" значение: не валидное;
3. Внести в поле "Месяц" значение: пустое;
4. Внести в поле "Год" значение: валидное;
...
_Сценарий 2.7.7  Тестирование отправки формы "Купить". Негативное_
1. Выполнить сценарии 1.1 или 1.3;
...
_Сценарий 2.7.8  Тестирование отправки формы "Купить". Негативное_
1. Выполнить сценарии 1.1 или 1.3;
2. Внести в поле "Номер карты" значение: пустое;
3. Внести в поле "Месяц" значение: не валидное;
4. Внести в поле "Год" значение: пустое;
...
_Сценарий 2.7.9  Тестирование отправки формы "Купить". Негативное_
1. Выполнить сценарии 1.1 или 1.3;
2. Внести в поле "Номер карты" значение: пустое;
3. Внести в поле "Месяц" значение: пустое;
4. Внести в поле "Год" значение: валидное;
...
_Сценарий 2.8  Тестирование отправки формы "Купить в кредит"_
